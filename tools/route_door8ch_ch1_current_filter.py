"""Route the channel 1 current-sense filter node locally."""
...
if LOCK_PATH.exists():
    raise SystemExit("Close DOOR-8CH in KiCad before routing channel 1 current filter")
...
track.SetStart(point(29.94, 72.00))
track.SetEnd(point(33.23, 72.00))
board.Add(track)
